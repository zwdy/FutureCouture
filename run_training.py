...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, mirror_augment_v, augmentations, metrics, min_h, min_w, res_log2, lr, cond, resume_pkl, resume_kimg,use_attention,resume_with_new_nets):
